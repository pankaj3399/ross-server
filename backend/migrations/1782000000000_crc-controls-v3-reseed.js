...
var CONTROLS_DATA = [
  {
    ...
    "aima_mapping": {
      "domain": "",
      "area": "",
      "maturity_enhancement": ""
    },
    "existing_certification_relevance": "If your organization has vendor management processes under ISO 27001, ISO 31000, SOC 2, or other applicable certifications, extend them to include AI-specific due diligence criteria such as model transparency, training data provenance, bias testing evidence, and contractual obligations for AI component compliance.",
    "risk_description": "Maps to: AI Risk Management Domain - Third-Party Risk. Maturity Enhancement: Extends governance to supply chain for Level 3 maturity.",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "If your organization already has an incident response or management plan under ISO 27001, SOC 2, or other applicable certifications, review it for AI-specific gaps. You will likely need to add AI-specific incident categories (model failures, bias events, adversarial attacks), AI severity classification criteria, and EU AI Act Article 73 serious incident notification procedures. Extend your existing plan rather than creating a new one.",
    "risk_description": "Maps to: AI Risk Management Domain - Business Continuity. Maturity Enhancement: Ensures operational resilience for Level 3 maturity.",
    "expected_timeline": ""
  },
  {
    ...
    "compliance_mapping": {
      ...
      "iso_42001": [
        ...
        {
          "ref": "N/A",
          "context": "require corrective actions"
        }
      ]
    },
    "aima_mapping": {
    ...
    "existing_certification_relevance": "If your organization has vendor management processes under ISO 27001, ISO 9001, or other applicable certifications, extend them to include AI-specific due diligence criteria such as model transparency, training data provenance, bias testing evidence, and contractual obligations for AI component compliance.",
    "risk_description": "Maps to: AI Risk Management Domain - Supplier Quality. Maturity Enhancement: Extends quality management to supply chain for Level 3 maturity.",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "If your organization has governance structures under ISO 27001, SOC 2, or other applicable certifications, extend them to include AI-specific oversight responsibilities, AI risk accountability, and designated AI governance roles per ISO 42001 requirements.",
    "risk_description": "Maps to: Governance & Strategy Domain - Organizational Structure. Maturity Enhancement: Core requirement for Level 2 (Managed) maturity.",
    "expected_timeline": ""
  },
  {
    ...
    "compliance_mapping": {
      ...
      "iso_42001": [
        ...
        {
          "ref": "Annex A.2.3",
          "context": "Internal AI governance roles established within the management system"
        }
      ]
    },
    "aima_mapping": {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: Governance & Strategy Domain - Accountability Framework. Maturity Enhancement: Essential for Level 2 maturity; enables audit trail.",
    "expected_timeline": ""
  },
  {
    ...
    "compliance_mapping": {
      "eu_ai_act": [
        ...
        {
          "ref": "Article 17(1)(m)",
          "context": "Accountability framework setting out responsibilities of management and other staff"
        }
      ],
      "nist_ai_rmf": [
        {
      ...
      "iso_42001": [
        ...
        {
          "ref": "Annex A.6.1",
          "context": "Top management shall provide guidance for the responsible design and development of AI systems"
        }
      ]
    },
    "aima_mapping": {
    ...
    "existing_certification_relevance": "If your organization has governance structures under ISO 27001, SOC 2, or other applicable certifications, extend them to include AI-specific oversight responsibilities, AI risk accountability, and designated AI governance roles per ISO 42001 requirements.",
    "risk_description": "Maps to: Governance & Strategy Domain - Executive Engagement. Maturity Enhancement: Critical for Level 3 (Defined) maturity.",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "If your organization has stakeholder communication or reporting processes under ISO 27001, or other applicable certifications, extend them to include AI-specific topics such as AI system transparency disclosures, algorithmic decision explanations, AI incident notifications, and EU AI Act regulatory reporting.",
    "risk_description": "Maps to: Governance & Strategy Domain - Communication Management. Maturity Enhancement: Structured communication supports Level 2 maturity.",
    "expected_timeline": ""
  },
  {
    ...
    "compliance_mapping": {
      "eu_ai_act": [
        {
          "ref": "Article 4",
          "context": "Providers and deployers shall ensure staff and others operating AI on their behalf have a sufficient level of AI literacy"
        },
        {
          "ref": "",
          "context": "Article 14: Human oversight competence requirements"
        }
      ],
      "nist_ai_rmf": [
        {
    ...
    "existing_certification_relevance": "If your organization has a training and competency program under ISO 27001, ISO 9001, SOC 2, or other applicable certifications, extend it to cover AI-specific literacy requirements including EU AI Act Article 4 obligations, AI risk awareness, responsible AI practices, and role-specific AI competency benchmarks.",
    "risk_description": "Maps to: Governance & Strategy Domain - Human Capital. Maturity Enhancement: Enables skilled workforce essential for Level 2 maturity.",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: Governance & Strategy Domain - Organizational Culture. Maturity Enhancement: Cultural foundation for Level 3 (Defined) maturity.",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: Governance & Strategy Domain - Customer Relations. Maturity Enhancement: Customer-centric development supports Level 3 maturity.",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: AI Lifecycle Management Domain - Retirement. Maturity Enhancement: Completes full lifecycle governance; essential for Level 3 maturity.",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: Governance & Strategy Domain - Team Composition. Maturity Enhancement: Enables comprehensive risk identification for Level 3 maturity.",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "If your organization has document control processes under ISO 27001, ISO 9001, SOC 2, or other applicable certifications, extend them to cover AI-specific documentation including model cards, technical documentation per EU AI Act Annex IV, data provenance records, and AI system version histories.",
    "risk_description": "Maps to: Governance & Strategy Domain - Information Management. Maturity Enhancement: Document control foundational for Level 2 maturity; enables repeatability and audit readiness.",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: Governance & Strategy Domain - Asset Management. Maturity Enhancement: Prerequisite for Level 1 to Level 2 transition.",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: AI Risk Management Domain - Risk Classification. Maturity Enhancement: Enables risk-proportionate governance for Level 2 maturity.",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: Governance & Strategy Domain - Policy Framework. Maturity Enhancement: Establishes foundational governance for Level 2 (Managed) maturity.",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "If your organization has governance policies under ISO 27001, SOC 2, or other applicable certifications, review them for AI applicability. You may need to extend existing policies to address AI ethics principles, acceptable AI use, AI risk tolerance, and compliance with EU AI Act, NIST AI RMF, and ISO 42001 requirements.",
    "risk_description": "Maps to: Governance & Strategy Domain - Strategic Alignment. Maturity Enhancement: Progresses from ad-hoc to strategically managed; prerequisite for Level 3.",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "If your organization has governance policies under ISO 27001, ISO 9001, SOC 2, or other applicable certifications, review them for AI applicability. You may need to extend existing policies to address AI ethics principles, acceptable AI use, AI risk tolerance, and compliance with EU AI Act, NIST AI RMF, and ISO 42001 requirements.",
    "risk_description": "Maps to: Governance & Strategy Domain - Continuous Improvement. Maturity Enhancement: Enables adaptive governance; supports Level 4 maturity.",
    "expected_timeline": ""
  },
  {
    ...
    "compliance_mapping": {
      "eu_ai_act": [
        ...
        {
          "ref": "Article 8(2) (for AI in products subject to Annex I Section A harmonisation legislation)",
    ...
    "existing_certification_relevance": "If your organization has audit or compliance monitoring programs under ISO 27001, SOC 2, or other applicable certifications, extend the scope to include AI-specific audit objectives, AI system performance verification, algorithmic fairness checks, and compliance with EU AI Act, NIST AI RMF, and ISO 42001.",
    "risk_description": "Maps to: Governance & Strategy Domain - Regulatory Compliance. Maturity Enhancement: Establishes compliance infrastructure for Level 2 maturity.",
    "expected_timeline": ""
  },
  {
    ...
    "compliance_mapping": {
      "eu_ai_act": [
        {
          "ref": "Article 87",
          "context": "Reporting of infringements and protection of reporting persons per Whistleblower Directive (EU) 2019/1937"
        }
      ],
      "nist_ai_rmf": [
        {
    ...
    "existing_certification_relevance": "If your organization has stakeholder communication or reporting processes under ISO 27001, SOC 2, or other applicable certifications, extend them to include AI-specific topics such as AI system transparency disclosures, algorithmic decision explanations, AI incident notifications, and EU AI Act regulatory reporting.",
    "risk_description": "Maps to: Governance & Strategy Domain - Reporting Infrastructure. Maturity Enhancement: Reporting mechanisms essential for Level 3 maturity enabling proactive risk identification.",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: AI Risk Management Domain - Risk Framework. Maturity Enhancement: Foundational for Level 2; enables quantitative management for Level 4.",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: Governance & Strategy Domain - Scope Management. Maturity Enhancement: Foundational for Level 2 maturity; clear scope enables audit readiness.",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: Governance & Strategy Domain - Knowledge Management. Maturity Enhancement: Information sharing supports Level 4 maturity through industry benchmarking.",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "If your organization has stakeholder communication or reporting processes under ISO 9001, or other applicable certifications, extend them to include AI-specific topics such as AI system transparency disclosures, algorithmic decision explanations, AI incident notifications, and EU AI Act regulatory reporting.",
    "risk_description": "Maps to: Governance & Strategy Domain - Stakeholder Relations. Maturity Enhancement: External engagement essential for Level 3 maturity.",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "If your organization has similar processes or documentation under GDPR, ISO 9001, or other applicable certifications, review them for AI applicability. You may be able to extend existing artifacts with AI-specific requirements rather than creating new standalone documents.",
    "risk_description": "Maps to: Governance & Strategy Domain - Continuous Improvement. Maturity Enhancement: Closes feedback loop essential for Level 4 maturity.",
    "expected_timeline": ""
  },
  {
    ...
    "compliance_mapping": {
      ...
      "iso_42001": [
        ...
        {
          "ref": "N/A",
          "context": "may become unfeasible from financial perspective"
        }
      ]
    },
    "aima_mapping": {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: AI Risk Management Domain - Solution Assessment. Maturity Enhancement: Alternative analysis supports Level 2 (Managed) maturity with informed decision-making.",
    "expected_timeline": ""
  },
  {
    ...
    "compliance_mapping": {
      "eu_ai_act": [
        {
          "ref": "N/A",
          "context": "No direct EU AI Act requirement to document benefits"
        },
        {
          "ref": "N/A",
          "context": "supports Article 9 risk management context"
        }
      ],
      "nist_ai_rmf": [
        {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: AI Risk Management Domain - Benefits Assessment. Maturity Enhancement: Benefits documentation supports Level 2 maturity with informed decision-making.",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: AI Risk Management Domain - Consequence Assessment. Maturity Enhancement: Error cost assessment supports Level 3 maturity with comprehensive risk understanding.",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: AI Risk Management Domain - Decision Governance. Maturity Enhancement: Formal decision process essential for Level 3 (Defined) maturity with stage-gate governance.",
    "expected_timeline": ""
  },
  {
    ...
    "compliance_mapping": {
      ...
      "iso_42001": [
        ...
        {
          "ref": "N/A",
          "context": "Evaluate by comparing with criteria"
        }
      ]
    },
    "aima_mapping": {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: AI Risk Management Domain - Risk Analysis. Maturity Enhancement: Structured evaluation enables Level 3 maturity with consistent risk comparison across portfolio.",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: AI Risk Management Domain - Risk Identification. Maturity Enhancement: Systematic risk identification essential for Level 2 maturity.",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: AI Risk Management Domain - Impact Assessment. Maturity Enhancement: Systematic impact assessment foundational for Level 2 maturity; supports human rights due diligence.",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: AI Risk Management Domain - Human Rights Assessment. Maturity Enhancement: Individual and group impact assessment supports Level 3 maturity; required for fundamental rights compliance.",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: AI Risk Management Domain - Societal Impact. Maturity Enhancement: Societal impact assessment supports Level 4 maturity with comprehensive impact understanding.",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: AI Risk Management Domain - Independent Assurance. Maturity Enhancement: Independent assessment required for Level 3 maturity and conformity assessment compliance.",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: AI Risk Management Domain - Risk Measurement. Maturity Enhancement: Defined measurement supports Level 3 maturity; quantitative metrics enable Level 4.",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: AI Risk Management Domain - Risk Monitoring. Maturity Enhancement: Continuous monitoring essential for Level 4 (Quantitatively Managed) maturity.",
    "expected_timeline": ""
  },
  {
    ...
    "compliance_mapping": {
      "eu_ai_act": [
        ...
        {
          "ref": "N/A",
          "context": "risks shall be communicated to users"
        }
      ],
      "nist_ai_rmf": [
        {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: AI Risk Management Domain - Risk Acceptance. Maturity Enhancement: Explicit residual risk acceptance supports Level 3 maturity with documented risk decisions.",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: AI Risk Management Domain - Control Framework. Maturity Enhancement: Statement of Applicability required for ISO 42001 certification; supports Level 3 maturity.",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: AI Risk Management Domain - Risk Framework. Maturity Enhancement: Comprehensive risk management foundational for Level 2 maturity.",
    "expected_timeline": ""
  },
  {
    ...
    "compliance_mapping": {
      ...
      "iso_42001": [
        ...
        {
          "ref": "N/A",
          "context": "Determine controls"
        },
        {
          "ref": "N/A",
          "context": "Formulate treatment plan"
        },
        {
          "ref": "Clause 8.3",
    ...
    "existing_certification_relevance": "If your organization maintains a risk management framework under ISO 27001, ISO 31000, or other applicable certifications, your existing processes can serve as the foundation. Extend them to include AI-specific risk categories (model drift, algorithmic bias, adversarial vulnerabilities, transparency gaps), AI-specific impact criteria, and AI system lifecycle risk considerations.",
    "risk_description": "Maps to: AI Risk Management Domain - Risk Treatment. Maturity Enhancement: Systematic treatment planning core to Level 2 maturity with documented risk responses.",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: AI Risk Management Domain - Vulnerable Population Protection. Maturity Enhancement: Vulnerable population assessment mandatory for high-risk AI compliance; supports Level 3 maturity.",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: AI Development Lifecycle Domain - System Design. Maturity Enhancement: Architecture documentation supports Level 3 maturity with comprehensive design records.",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "If your organization has deployment or infrastructure processes under ISO 27001, SOC 2, or other applicable certifications, extend them to address AI-specific considerations including model rollback procedures, post-deployment monitoring activation, and AI system retirement planning.",
    "risk_description": "Maps to: AI Development Lifecycle Domain - Deployment Management\nMaturity Enhancement: Formal deployment processes required for Level 3 maturity with controlled release management",
    "expected_timeline": ""
  },
  {
    ...
    "compliance_mapping": {
      "eu_ai_act": [
        ...
        {
          "ref": "N/A",
          "context": "however sustainability increasingly relevant to conformity assessment"
        }
      ],
      "nist_ai_rmf": [
        {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: AI Development Lifecycle Domain - Sustainability Management\nMaturity Enhancement: Environmental sustainability assessment supports Level 3 maturity with responsible AI operations",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: AI Development Lifecycle Domain - Human Oversight Design\nMaturity Enhancement: Human oversight mechanisms essential for Level 3 maturity with effective human-AI collaboration",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "If your organization has document control processes under ISO 27001, ISO 9001, SOC 2, or other applicable certifications, extend them to cover AI-specific documentation including model cards, technical documentation per EU AI Act Annex IV, data provenance records, and AI system version histories.",
    "risk_description": "Maps to: AI Development Lifecycle Domain - Infrastructure. Maturity Enhancement: Infrastructure documentation supports Level 2 maturity with operational readiness.",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: AI Lifecycle Management Domain - Stage Governance\nMaturity Enhancement: Lifecycle management framework essential for Level 2 maturity with systematic AI governance",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: AI Development Lifecycle Domain - Model Development. Maturity Enhancement: Algorithm documentation essential for Level 3 maturity with scientific rigor and reproducibility.",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: AI Development Lifecycle Domain - Model Management. Maturity Enhancement: Pre-trained model management supports Level 3 maturity with supply chain visibility.",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: AI Development Lifecycle Domain - Requirements Engineering. Maturity Enhancement: Comprehensive requirements specification essential for Level 2 maturity with traceable development.",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: AI Development Lifecycle Domain - User Interface Design\nMaturity Enhancement: Comprehensive UI documentation supports Level 2 maturity with user-centered AI transparency",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: AI Development Lifecycle Domain - Requirements Definition. Maturity Enhancement: Intended purpose definition foundational for Level 2 maturity; enables scope control and validation.",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: AI Development Lifecycle Domain - Transparency. Maturity Enhancement: Limitations documentation supports Level 3 maturity with comprehensive system understanding.",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "If your organization has similar processes or documentation under ISO 27001, SOC 2, or other applicable certifications, review them for AI applicability. You may be able to extend existing artifacts with AI-specific requirements rather than creating new standalone documents.",
    "risk_description": "Maps to: AI Development Lifecycle Domain - Configuration Management. Maturity Enhancement: Version control essential for Level 2 maturity with reproducibility and security.",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: AI Development Lifecycle Domain - Data Assumptions Management\nMaturity Enhancement: Explicit assumption documentation essential for Level 2 maturity with validated measurement constructs and monitored assumption dependencies",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: AI Development Lifecycle Domain - Training Data Bias Detection\nMaturity Enhancement: Systematic bias detection essential for Level 3 maturity with quantified fairness metrics and automated bias monitoring pipelines",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: AI Development Lifecycle Domain - Training Data Bias Mitigation\nMaturity Enhancement: Validated bias mitigation with quantified effectiveness metrics essential for Level 4 maturity demonstrating measurable bias reduction and continuous fairness monitoring",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: AI Development Lifecycle Domain - Data Acquisition\nMaturity Enhancement: Documented collection processes essential for Level 2 maturity with traceable data lineage",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: AI Development Lifecycle Domain - Data Gap Management\nMaturity Enhancement: Systematic gap identification and remediation essential for Level 2 maturity with tracked closure of data deficiencies",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "If your organization has governance structures under GDPR, ISO 27001, SOC 2, or other applicable certifications, extend them to include AI-specific oversight responsibilities, AI risk accountability, and designated AI governance roles per ISO 42001 requirements.",
    "risk_description": "Maps to: AI Development Lifecycle Domain - Data Management\nMaturity Enhancement: Data governance framework foundational for Level 2 maturity with controlled data practices",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: AI Development Lifecycle Domain - Data Labelling Quality\nMaturity Enhancement: Structured labelling processes with measured agreement essential for Level 3 maturity with verifiable annotation quality",
    "expected_timeline": ""
  },
  {
    ...
    "compliance_mapping": {
      ...
      "nist_ai_rmf": [
        {
          "ref": "N/A",
          "context": "N/A - No direct NIST AI RMF mapping for this control"
        }
      ],
      "iso_42001": [
        {
    ...
    "existing_certification_relevance": "If your organization has similar processes or documentation under GDPR, ISO 27001, SOC 2, or other applicable certifications, review them for AI applicability. You may be able to extend existing artifacts with AI-specific requirements rather than creating new standalone documents.",
    "risk_description": "Maps to: AI Development Lifecycle Domain - AI Data Governance\nMaturity Enhancement: Comprehensive data management system with documented procedures and automated lifecycle controls essential for Level 3 maturity demonstrating systematic AI data governance",
    "expected_timeline": ""
  },
  {
    ...
    "compliance_mapping": {
      ...
      "nist_ai_rmf": [
        {
          "ref": "N/A",
          "context": "N/A — No direct NIST AI RMF mapping"
        },
        {
          "ref": "N/A",
          "context": "supports data management standards"
        }
      ],
      "iso_42001": [
        {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: AI Development Lifecycle Domain - Data Preparation Pipeline\nMaturity Enhancement: Documented and reproducible data preparation processes essential for Level 2 maturity with traceable data transformation pipelines",
    "expected_timeline": ""
  },
  {
    ...
    "compliance_mapping": {
      "eu_ai_act": [
        {
          "ref": "Article 10(5)(b),(c)",
          "context": "Processing of special categories for bias detection"
        },
        {
          "ref": "Article 26(8)-(10)",
          "context": "Deployer data protection obligations"
        },
        {
          "ref": "Recital 10",
          "context": "GDPR fully applies to personal data processed in connection with AI systems"
        }
      ],
      "nist_ai_rmf": [
        {
    ...
    "existing_certification_relevance": "If your organization has data protection processes under GDPR, ISO 27001, ISO 27701, or other applicable certifications, these provide a strong foundation. Extend them to address AI-specific requirements including automated decision-making safeguards, training data bias examination under EU AI Act Article 10(5), and AI-specific data subject rights.",
    "risk_description": "Maps to: AI Development Lifecycle Domain - AI Privacy Protection\nMaturity Enhancement: Comprehensive AI privacy controls essential for Level 3 maturity with validated pseudonymization and quantified re-identification risk management",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: AI Development Lifecycle Domain - Data Provenance and Lineage\nMaturity Enhancement: End-to-end provenance tracking essential for Level 3 maturity with verifiable data lineage from source to model",
    "expected_timeline": ""
  },
  {
    ...
    "compliance_mapping": {
      ...
      "iso_42001": [
        ...
        {
          "ref": "N/A",
          "context": "ensure data meet those requirements"
        }
      ]
    },
    "aima_mapping": {
    ...
    "existing_certification_relevance": "If your organization has similar processes or documentation under ISO 27001, ISO 9001, or other applicable certifications, review them for AI applicability. You may be able to extend existing artifacts with AI-specific requirements rather than creating new standalone documents.",
    "risk_description": "Maps to: AI Development Lifecycle Domain - Data Quality Assurance\nMaturity Enhancement: Data quality management essential for Level 2 maturity with measurable data standards",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "If your organization has similar processes or documentation under ISO 27001, ISO 9001, or other applicable certifications, review them for AI applicability. You may be able to extend existing artifacts with AI-specific requirements rather than creating new standalone documents.",
    "risk_description": "Maps to: AI Development Lifecycle Domain - Data Quality Measurement\nMaturity Enhancement: Quantified data quality measurement essential for Level 3 maturity with automated TEVV-integrated quality monitoring",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: AI Development Lifecycle Domain - Data Representativeness\nMaturity Enhancement: Systematic representativeness assessment essential for Level 3 maturity with quantified population coverage and gap remediation",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: AI Development Lifecycle Domain - Sensitive Data Protection\nMaturity Enhancement: Strict special category data controls essential for Level 3 maturity with demonstrable compliance with Article 10(5) safeguard requirements",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "If your organization has similar processes or documentation under ISO 27001, ISO 9001, SOC 2, or other applicable certifications, review them for AI applicability. You may be able to extend existing artifacts with AI-specific requirements rather than creating new standalone documents.",
    "risk_description": "Maps to: AI Development Lifecycle Domain - Validation and Testing Data\nMaturity Enhancement: Rigorous test data management essential for Level 3 maturity with validated evaluation processes",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: AI Development Lifecycle Domain - Training Data Management\nMaturity Enhancement: Comprehensive training data documentation required for Level 3 maturity with auditable data practices",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: AI Risk Management Domain - AI Performance Measurement\nMaturity Enhancement: Rigorous accuracy testing with subgroup analysis and declared metrics essential for Level 4 maturity demonstrating quantified and transparent AI performance measurement",
    "expected_timeline": ""
  },
  {
    ...
    "compliance_mapping": {
      ...
      "nist_ai_rmf": [
        ...
        {
          "ref": "N/A",
          "context": "supports verification and validation processes"
        }
      ],
      "iso_42001": [
        {
          "ref": "N/A",
          "context": "N/A — Supports overall ISO 42001 verification and validation processes"
        }
      ]
    },
    "aima_mapping": {
    ...
    "existing_certification_relevance": "If your organization has audit or compliance monitoring programs under ISO 27001, SOC 2, or other applicable certifications, extend the scope to include AI-specific audit objectives, AI system performance verification, algorithmic fairness checks, and compliance with EU AI Act, NIST AI RMF, and ISO 42001.",
    "risk_description": "Maps to: AI Governance Domain - Conformity Assessment and Market Access\nMaturity Enhancement: Completed conformity assessment with comprehensive evidence package and documented assessment procedure essential for Level 4 maturity demonstrating regulatory readiness for high-risk AI market placement",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "If your organization has similar processes or documentation under ISO 27001, ISO 31000, ISO 9001, or other applicable certifications, review them for AI applicability. You may be able to extend existing artifacts with AI-specific requirements rather than creating new standalone documents.",
    "risk_description": "Maps to: AI Monitoring Domain - Continuous Learning Risk Management\nMaturity Enhancement: Automated continuous learning monitoring with feedback loop detection and bias drift alerts essential for Level 4 maturity in autonomous AI system governance",
    "expected_timeline": ""
  },
  {
    ...
    "compliance_mapping": {
      ...
      "iso_42001": [
        {
          "ref": "N/A",
          "context": "• N/A - No direct ISO/IEC 42001 mapping for this control"
        }
      ]
    },
    "aima_mapping": {
    ...
    "existing_certification_relevance": "If your organization has audit or compliance monitoring programs under ISO 27001, SOC 2, or other applicable certifications, extend the scope to include AI-specific audit objectives, AI system performance verification, algorithmic fairness checks, and compliance with EU AI Act, NIST AI RMF, and ISO 42001.",
    "risk_description": "Maps to: AI Governance Domain - Regulatory Declaration and Market Access\nMaturity Enhancement: Formally executed EU declaration of conformity with complete version control and distribution records essential for Level 4 maturity demonstrating full regulatory compliance readiness for high-risk AI market placement",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: AI Lifecycle Management Domain - Design Control and Verification\nMaturity Enhancement: Formal design control with stage-gated reviews, requirements traceability, and change management essential for Level 4 maturity demonstrating engineering discipline in AI system development",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: AI Lifecycle Management Domain - Development Quality Assurance\nMaturity Enhancement: Systematic development quality control with defined gates, mandatory code reviews, and milestone-based quality assurance essential for Level 4 maturity demonstrating disciplined AI development practices",
    "expected_timeline": ""
  },
  {
    ...
    "compliance_mapping": {
      "eu_ai_act": [
        {
          "ref": "N/A",
          "context": "N/A — Supports overall verification and validation processes"
        }
      ],
      "nist_ai_rmf": [
        {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: AI Risk Management Domain - Field Validation and Expert Assessment\nMaturity Enhancement: Structured domain expert field validation with longitudinal performance trend analysis essential for Level 3 maturity demonstrating deployment-context trustworthiness verification",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "If your organization has similar processes or documentation under ISO 27001, SOC 2, or other applicable certifications, review them for AI applicability. You may be able to extend existing artifacts with AI-specific requirements rather than creating new standalone documents.",
    "risk_description": "Maps to: AI Governance Domain - Harmonised Regulatory Integration\nMaturity Enhancement: Integrated multi-framework compliance with coordinated conformity assessment essential for Level 3 maturity demonstrating comprehensive regulatory alignment for AI products",
    "expected_timeline": ""
  },
  {
    ...
    "compliance_mapping": {
      "eu_ai_act": [
        {
          "ref": "Article 60",
          "context": "Real-world testing of high-risk AI systems"
        },
        {
          "ref": "Article 61",
          "context": "Informed consent to participate in real-world testing"
        }
      ],
      "nist_ai_rmf": [
        {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: AI Risk Management Domain - Human-Centered AI Evaluation\nMaturity Enhancement: Ethical human subject evaluation with representative sampling and bias assessment essential for Level 3 maturity demonstrating responsible AI evaluation practices",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: AI Risk Management Domain - Performance Measurement Governance\nMaturity Enhancement: Validated context-specific metrics with documented sensitivity analysis and regular appropriateness review essential for Level 3 maturity demonstrating meaningful and trustworthy AI performance measurement",
    "expected_timeline": ""
  },
  {
    ...
    "compliance_mapping": {
      ...
      "nist_ai_rmf": [
        ...
        {
          "ref": "N/A",
          "context": "interpret AI system output within its intended deployment context with appropriate uncertainty characterization"
        }
      ],
      "iso_42001": [
        {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: AI Risk Management Domain - Model Validation and Explainability\nMaturity Enhancement: Comprehensive model validation with multi-stakeholder explanation artifacts and calibrated output interpretation essential for Level 4 maturity demonstrating transparent and accountable AI system governance",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: AI Risk Management Domain - Pre-Deployment Verification\nMaturity Enhancement: Formal pre-deployment testing with signed release authorization essential for Level 3 maturity demonstrating controlled AI system release processes",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "If your organization has similar processes or documentation under ISO 27001, ISO 9001, or other applicable certifications, review them for AI applicability. You may be able to extend existing artifacts with AI-specific requirements rather than creating new standalone documents.",
    "risk_description": "Maps to: AI Governance Domain - Quality Management System\nMaturity Enhancement: Comprehensive documented QMS with proportionate controls and continuous improvement processes essential for Level 4 maturity demonstrating systematic AI quality governance",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: AI Governance Domain - Documentation and Record Management\nMaturity Enhancement: Systematic record-keeping with automated retention enforcement and comprehensive classification essential for Level 3 maturity demonstrating organized compliance infrastructure",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: AI Governance Domain - Resource and Supply Chain Management\nMaturity Enhancement: Comprehensive resource management with security-of-supply measures and supply chain risk assessment supports Level 3 maturity demonstrating operational resilience for AI system continuity",
    "expected_timeline": ""
  },
  {
    ...
    "compliance_mapping": {
      ...
      "iso_42001": [
        ...
        {
          "ref": "Annex A.6.2.6",
          "context": "AI system verification and validation"
        }
      ]
    },
    "aima_mapping": {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: AI Risk Management Domain - AI System Robustness\nMaturity Enhancement: Comprehensive robustness testing with chaos engineering and environmental variation analysis essential for Level 4 maturity demonstrating validated AI system resilience",
    "expected_timeline": ""
  },
  {
    ...
    "compliance_mapping": {
      ...
      "nist_ai_rmf": [
        ...
        {
          "ref": "N/A",
          "context": "demonstrate system safety, acceptable residual risk, and ability to fail safely under foreseeable conditions"
        }
      ],
      "iso_42001": [
        {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: AI Risk Management Domain - AI System Safety Assurance\nMaturity Enhancement: Systematic safety testing with FMEA, validated fail-safe mechanisms, and safety certification essential for Level 4 maturity in safety-critical AI deployments",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: AI Risk Management Domain - AI Security and Adversarial Defense\nMaturity Enhancement: Comprehensive AI security testing with adversarial robustness validation and continuous threat monitoring essential for Level 4 maturity in AI security posture",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: AI Lifecycle Management Domain - Stage-Gate Testing and Validation\nMaturity Enhancement: Systematic stage-gate testing with documented validation at each development phase essential for Level 4 maturity demonstrating comprehensive verification and validation discipline",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "If your organization has similar processes or documentation under ISO 27001, SOC 2, or other applicable certifications, review them for AI applicability. You may be able to extend existing artifacts with AI-specific requirements rather than creating new standalone documents.",
    "risk_description": "Maps to: AI Governance Domain - Standards and Regulatory Compliance\nMaturity Enhancement: Systematic standards application with documented compliance evidence and gap analysis essential for Level 3 maturity demonstrating standards-based AI governance",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: AI Risk Management Domain - AI System Testing and Validation\nMaturity Enhancement: Comprehensive TEVV framework with qualified tools and effectiveness monitoring essential for Level 3 maturity demonstrating systematic AI quality assurance",
    "expected_timeline": ""
  },
  {
    ...
    "compliance_mapping": {
      ...
      "nist_ai_rmf": [
        ...
        {
          "ref": "N/A",
          "context": "accessibility supports broader trustworthiness and equity objectives"
        }
      ],
      "iso_42001": [
        {
    ...
    "existing_certification_relevance": "If your organization has audit or compliance monitoring programs under ISO 27001, SOC 2, or other applicable certifications, extend the scope to include AI-specific audit objectives, AI system performance verification, algorithmic fairness checks, and compliance with EU AI Act, NIST AI RMF, and ISO 42001.",
    "risk_description": "Maps to: AI Operations Domain - Accessibility and Inclusive Design Controls\nMaturity Enhancement: Systematic accessibility compliance with automated scanning, assistive technology testing, and published accessibility statements essential for Level 3 maturity demonstrating inclusive AI system deployment meeting EU regulatory accessibility requirements",
    "expected_timeline": ""
  },
  {
    ...
    "compliance_mapping": {
      "eu_ai_act": [
        {
          "ref": "N/A",
          "context": "N/A — Supports overall operational monitoring requirements"
        }
      ],
      "nist_ai_rmf": [
        {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: AI Governance Domain - Internal Audit and Independent Assurance\nMaturity Enhancement: Planned internal audit programme with AI-competent independent auditors and tracked findings essential for Level 3 maturity demonstrating systematic verification of AI management system conformity and effectiveness",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "If your organization has change management processes under ISO 27001, ITIL, SOC 2, or other applicable certifications, extend them to include AI-specific change categories (model retraining, data pipeline changes, threshold adjustments, feature engineering) and AI-specific impact assessment criteria.",
    "risk_description": "Maps to: AI Operations Domain - Change Control and Configuration Management\nMaturity Enhancement: Formal change management with pre-determined change documentation and compliance impact assessment essential for Level 3 maturity demonstrating controlled AI system evolution throughout operational lifetime",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "If your organization has audit or compliance monitoring programs under ISO 27001, SOC 2, or other applicable certifications, extend the scope to include AI-specific audit objectives, AI system performance verification, algorithmic fairness checks, and compliance with EU AI Act, NIST AI RMF, and ISO 42001.",
    "risk_description": "Maps to: AI Governance Domain - Continuous Compliance and Regulatory Management\nMaturity Enhancement: Continuous compliance monitoring with regulatory change tracking and trend analysis essential for Level 4 maturity demonstrating proactive and sustained regulatory compliance management across all AI systems",
    "expected_timeline": ""
  },
  {
    ...
    "compliance_mapping": {
      "eu_ai_act": [
        {
          "ref": "N/A",
          "context": "N/A - No direct EU AI Act article mapping"
        },
        {
          "ref": "N/A",
          "context": "however, production data quality monitoring supports Article 9 risk management and Article 15 accuracy requirements indirectly"
        }
      ],
      "nist_ai_rmf": [
        {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: AI Operations Domain - Production Data Quality and Drift Monitoring Controls\nMaturity Enhancement: Continuous production data monitoring with automated drift detection, quality dashboards, and data lineage tracking essential for Level 3 maturity demonstrating operational control over AI system data dependencies in production environments",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "If your organization has continual improvement or corrective action processes under ISO 27001, ISO 9001, or other applicable certifications, extend them to include AI-specific triggers such as model performance regression, bias detection, and feedback loops from AI monitoring to development.",
    "risk_description": "Maps to: AI Governance Domain - Continual Improvement and Maturity Advancement\nMaturity Enhancement: Systematic continual improvement with measurable outcomes, lessons learned integration, and maturity-aligned prioritization essential for Level 4 maturity demonstrating an adaptive and self-improving AI management system",
    "expected_timeline": ""
  },
  {
    ...
    "implementation": {
      ...
      "steps": [
        ...
        "Conduct regular incident response drills and tabletop exercises to validate plan effectiveness and identify gaps",
    ...
    "compliance_mapping": {
      ...
      "nist_ai_rmf": [
        ...
        {
          "ref": "MANAGE.4.3",
          "context": "Incident response plans exercised and maintained including regular drills and tabletop exercises"
        }
      ],
      "iso_42001": [
        {
    ...
    "existing_certification_relevance": "If your organization already has an incident response or management plan under ISO 27001, SOC 2, or other applicable certifications, review it for AI-specific gaps. You will likely need to add AI-specific incident categories (model failures, bias events, adversarial attacks), AI severity classification criteria, and EU AI Act Article 73 serious incident notification procedures. Extend your existing plan rather than creating a new one.",
    "risk_description": "Maps to: AI Operations Domain - Incident Detection, Response, and Recovery Management\nMaturity Enhancement: Comprehensive incident response with automated detection, structured investigation, and regulatory notification capability essential for Level 3 maturity demonstrating proactive incident management across all AI systems",
    "expected_timeline": ""
  },
  {
    ...
    "compliance_mapping": {
      ...
      "nist_ai_rmf": [
        ...
        {
          "ref": "N/A",
          "context": "supports operational monitoring requirements"
        }
      ],
      "iso_42001": [
        {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: AI Operations Domain - Incident Communication and Stakeholder Notification\nMaturity Enhancement: Structured incident communication with pre-approved templates, defined timelines, and disclosure logging essential for Level 3 maturity demonstrating transparent and regulatory-compliant stakeholder notification practices",
    "expected_timeline": ""
  },
  {
    ...
    "implementation": {
      ...
      "steps": [
        ...
        "Establish log retention and storage infrastructure with minimum 6-month minimum retention per Article 19 (Automatically generated logs), write-once-read-many",
    ...
    "compliance_mapping": {
      "eu_ai_act": [
        ...
        {
          "ref": "Article 19",
          "context": "Automatically generated logs shall be kept for at least 6 months unless Union or national law provides otherwise"
        }
      ],
      "nist_ai_rmf": [
        {
    ...
    "existing_certification_relevance": "If your organization has logging or record-keeping processes under ISO 27001, SOC 2, or other applicable certifications, extend them to include AI-specific logging requirements such as inference logs, model input/output records, performance metric histories, and automated event logging per EU AI Act Article 12.",
    "risk_description": "Maps to: AI Operations Domain - System Logging and Traceability\nMaturity Enhancement: Comprehensive automatic event logging with tamper-resistant storage and standardized schemas essential for Level 3 maturity demonstrating operational traceability and audit readiness",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: AI Operations Domain - Biometric System Oversight and Accountability\nMaturity Enhancement: Enhanced biometric-specific logging with privacy-preserving audit trails and human verifier accountability essential for Level 4 maturity demonstrating comprehensive oversight of high-sensitivity AI systems",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "If your organization has access control processes under ISO 27001, ISO 9001, SOC 2, or other applicable certifications, extend them to cover AI-specific requirements including model access controls, training data access restrictions, inference API security, and role-based permissions for AI system configuration.",
    "risk_description": "Maps to: AI Operations Domain - Deployer Enablement and Log Accessibility\nMaturity Enhancement: Comprehensive deployer log support with interpretation guides, training, and technical access mechanisms essential for Level 3 maturity demonstrating effective provider-deployer information sharing",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "If your organization has a training and competency program under ISO 27001, ISO 9001, SOC 2, or other applicable certifications, extend it to cover AI-specific literacy requirements including EU AI Act Article 4 obligations, AI risk awareness, responsible AI practices, and role-specific AI competency benchmarks.",
    "risk_description": "Maps to: AI Lifecycle Management Domain - Model Maintenance and Continuous Improvement\nMaturity Enhancement: Systematic model maintenance with evidence-based retraining triggers, comprehensive version control, and impact assessment essential for Level 4 maturity demonstrating sustained AI system value throughout operational lifetime",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: AI Governance Domain - Management Review and Strategic Oversight\nMaturity Enhancement: Structured management review with comprehensive inputs, documented decisions, and tracked actions essential for Level 3 maturity demonstrating active top management oversight and data-driven strategic direction of the AI management system",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "If your organization has similar processes or documentation under ISO 27001, SOC 2, or other applicable certifications, review them for AI applicability. You may be able to extend existing artifacts with AI-specific requirements rather than creating new standalone documents.",
    "risk_description": "Maps to: AI Monitoring Domain - Production Operations and Post-Market Surveillance\nMaturity Enhancement: Comprehensive production monitoring with automated drift detection and systematic post-market surveillance essential for Level 4 maturity demonstrating continuous operational oversight of deployed AI systems",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: AI Operations Domain - Nonconformity Management and Corrective Action\nMaturity Enhancement: Systematic nonconformity management with root cause analysis, effectiveness verification, and lessons learned integration essential for Level 3 maturity demonstrating organizational learning and prevention of recurring AI system failures",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: AI Operations Domain - Outsourced Process Control and Third-Party Risk Management\nMaturity Enhancement: Comprehensive outsourced process control with verified compliance, performance monitoring, and risk integration essential for Level 3 maturity demonstrating end-to-end AI governance including third-party managed processes",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: AI Operations Domain - Human Override, Intervention, and Emergency Shutdown Controls\nMaturity Enhancement: Comprehensive override and shutdown capabilities with tested mechanisms, authority governance, and event logging essential for Level 3 maturity demonstrating reliable human control over high-risk AI system operations",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "If your organization has user support processes under ISO 27001, ISO 9001, SOC 2, or other applicable certifications, extend them to cover AI-specific scenarios including explaining AI-driven decisions to users, handling AI output disputes, and providing human alternatives when AI systems fail.",
    "risk_description": "Maps to: AI Operations Domain - User Support and Help Desk Services\nMaturity Enhancement: Structured technical support with AI-trained personnel, defined SLAs, and feedback integration supports Level 2 maturity demonstrating responsive user support and systematic issue tracking for AI systems",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: AI Operations Domain - Intended Use Enforcement and Misuse Prevention Controls\nMaturity Enhancement: Technical use enforcement with automated misuse detection, boundary monitoring, and user agreement governance essential for Level 3 maturity demonstrating proactive control of AI system application within validated operational parameters",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: AI Transparency & Explainability Domain - Transparency by Design Architecture and Implementation\nMaturity Enhancement: Transparency-by-design with validated interpretability mechanisms, layered information architecture, and user comprehension testing essential for Level 3 maturity demonstrating that transparency is an inherent system property rather than an afterthought",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: AI Transparency & Explainability Domain - Deployer Documentation and Instructions for Use\nMaturity Enhancement: Comprehensive Instructions for Use with deployer-validated documentation, operational guides, and structured warnings essential for Level 3 maturity demonstrating that deployers have the information necessary for safe and compliant AI system operation",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: AI Transparency & Explainability Domain - Human Oversight Architecture and Control Design\nMaturity Enhancement: Risk-proportionate human oversight design with validated override mechanisms, oversight interface testing, and capacity planning essential for Level 3 maturity demonstrating effective human control over high-risk AI system operations",
    "expected_timeline": ""
  },
  {
    ...
    "compliance_mapping": {
      "eu_ai_act": [
        ...
        {
          "ref": "Article 4",
          "context": "AI literacy requirements for staff"
        }
      ],
      "nist_ai_rmf": [
        {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: AI Transparency & Explainability Domain - Human Oversight Competency and Automation Bias Mitigation\nMaturity Enhancement: Competency-based oversight training with automation bias awareness, qualification criteria, and effectiveness measurement essential for Level 3 maturity demonstrating that human oversight personnel are genuinely capable of exercising effective oversight authority",
    "expected_timeline": ""
  },
  {
    ...
    "compliance_mapping": {
      ...
      "nist_ai_rmf": [
        ...
        {
          "ref": "N/A",
          "context": "dual verification supports broader human oversight and trustworthiness objectives"
        }
      ],
      "iso_42001": [
        {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: AI Transparency & Explainability Domain - Biometric System Human Verification Controls\nMaturity Enhancement: Mandatory dual verification with independent assessment, tamper-evident logging, and verifier qualification essential for Level 3 maturity demonstrating rigorous human oversight of biometric identification systems as required by EU AI Act",
    "expected_timeline": ""
  },
  {
    ...
    "compliance_mapping": {
      "eu_ai_act": [
        ...
        {
          "ref": "N/A",
          "context": "Annex IV(1)(a) (intended purpose, provider name, version)"
        },
        {
          "ref": "Annex IV(8) (EU declaration of conformity per Article 47)",
      ...
      "nist_ai_rmf": [
        ...
        {
          "ref": "N/A",
          "context": "supports transparency and explainability requirements"
        }
      ],
      "iso_42001": [
        {
          "ref": "N/A",
          "context": "N/A — Supports overall ISO 42001 transparency and explainability requirements"
        }
      ]
    },
    "aima_mapping": {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: AI Transparency & Explainability Domain - Provider Identification and Conformity Marking. Maturity Enhancement: Complete provider identification with EU Declaration of Conformity and CE marking essential for Level 2 maturity demonstrating minimum regulatory compliance for market access.",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: AI Transparency & Explainability Domain - AI Interaction Disclosure and User Notification. Maturity Enhancement: Systematic notification with multi-language support, accessibility compliance, and auditable delivery logging essential for Level 3 maturity demonstrating proactive transparency in all AI interactions.",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: AI Transparency & Explainability Domain - Performance Disclosure and Accuracy Transparency\nMaturity Enhancement: Quantified performance disclosure with disaggregated metrics, robustness assessment, and deployer-comprehensible presentation essential for Level 3 maturity demonstrating transparent communication of AI system capabilities and limitations",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: AI Transparency & Explainability Domain - Regulatory Registration and Public Transparency. Maturity Enhancement: Timely EU database registration with ongoing maintenance and accuracy verification essential for Level 2 maturity demonstrating minimum regulatory compliance for market access.",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "If your organization has stakeholder communication or reporting processes under ISO 27001, SOC 2, or other applicable certifications, extend them to include AI-specific topics such as AI system transparency disclosures, algorithmic decision explanations, AI incident notifications, and EU AI Act regulatory reporting.",
    "risk_description": "Maps to: AI Transparency & Explainability Domain - Regulatory Authority Communication and Conformity Demonstration. Maturity Enhancement: Formalized authority communication with pre-approved templates, compliance readiness packages, and documented interaction history essential for Level 3 maturity demonstrating proactive regulatory engagement.",
    "expected_timeline": ""
  },
  {
    ...
    "compliance_mapping": {
      "eu_ai_act": [
        {
          "ref": "N/A",
          "context": "N/A — Supports overall transparency and explainability requirements"
        }
      ],
      "nist_ai_rmf": [
        {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: AI Transparency & Explainability Domain - External Stakeholder Feedback and Adverse Impact Reporting. Maturity Enhancement: Structured adverse impact reporting with processing workflows, response commitments, and reporter protections essential for Level 3 maturity demonstrating stakeholder-responsive AI governance.",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: AI Transparency & Explainability Domain - Risk and Limitation Disclosure to Stakeholders\nMaturity Enhancement: Comprehensive risk disclosure with context-specific guidance, residual risk communication, and misuse warnings essential for Level 3 maturity demonstrating transparent risk communication enabling informed stakeholder decision-making",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: AI Transparency & Explainability Domain - Technical Documentation and Compliance Evidence. Maturity Enhancement: Comprehensive Annex IV-compliant documentation system with version control and completeness validation essential for Level 3 maturity demonstrating systematic regulatory documentation practices.",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: AI Transparency & Explainability Domain - Documentation Lifecycle Management. Maturity Enhancement: Systematic documentation maintenance with version control, approval workflows, and freshness monitoring essential for Level 3 maturity demonstrating continuous documentation governance.",
    "expected_timeline": ""
  },
  {
    ...
    "compliance_mapping": {
      "eu_ai_act": [
        ...
        {
          "ref": "Article 86",
          "context": "Right to explanation of individual decision-making for affected persons"
        }
      ],
      "nist_ai_rmf": [
        {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: AI Transparency & Explainability Domain - Explainability Methods and Output Interpretation\nMaturity Enhancement: Validated explainability methods with user comprehension testing, fidelity assessment, and audience-appropriate presentation essential for Level 4 maturity demonstrating that AI system explanations genuinely enable understanding and informed oversight",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: AI Fairness & Non-Discrimination Domain - Algorithmic Bias Detection and Source Analysis. Maturity Enhancement: Multi-category algorithmic bias testing with source identification and targeted mitigation essential for Level 4 maturity demonstrating comprehensive bias governance.",
    "expected_timeline": ""
  },
  {
    ...
    "compliance_mapping": {
      "eu_ai_act": [
        {
          "ref": "Article 85",
          "context": "Right to lodge a complaint with market surveillance authority"
        },
        {
          "ref": "Article 86",
          "context": "Right to explanation of individual decision-making for affected persons subject to Annex III high-risk AI decisions"
        }
      ],
      "nist_ai_rmf": [
        {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: AI Fairness & Non-Discrimination Domain - Appeals, Redress, and Human Review Mechanisms. Maturity Enhancement: Formal appeals process with human review, redress mechanisms, and outcome tracking essential for Level 3 maturity demonstrating stakeholder-responsive fairness governance with accountability.",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: AI Fairness & Non-Discrimination Domain - Continuous Learning Fairness Safeguards. Maturity Enhancement: Feedback loop safeguards with continuous fairness monitoring, drift detection, and retraining validation essential for Level 4 maturity demonstrating advanced fairness governance for adaptive systems.",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: AI Fairness & Non-Discrimination Domain - Equal Opportunity and Error Rate Parity Testing. Maturity Enhancement: Equalized odds testing with threshold optimization and odds ratio analysis essential for Level 3 maturity demonstrating advanced fairness evaluation beyond demographic parity.",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: AI Fairness & Non-Discrimination Domain - Fairness Measurement and Metric Selection. Maturity Enhancement: Rigorous metric selection with trade-off analysis, justified thresholds, and context-appropriate rationale essential for Level 3 maturity demonstrating systematic fairness measurement.",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: AI Fairness & Non-Discrimination Domain - Bias Mitigation Strategy and Effectiveness Measurement. Maturity Enhancement: Systematic bias mitigation with technique selection rationale, effectiveness measurement, and ongoing monitoring essential for Level 4 maturity demonstrating operational bias management.",
    "expected_timeline": ""
  },
  {
    ...
    "compliance_mapping": {
      "eu_ai_act": [
        {
          "ref": "N/A",
          "context": "N/A — Supports overall fairness and non-discrimination requirements"
        }
      ],
      "nist_ai_rmf": [
        {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: AI Fairness & Non-Discrimination Domain - Fairness Governance and Objectives Definition. Maturity Enhancement: Documented fairness objectives integrated into AI lifecycle processes with stakeholder engagement and metrics rationale essential for Level 2 maturity establishing foundational fairness governance.",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: AI Fairness & Non-Discrimination Domain - Subgroup and Intersectional Performance Analysis. Maturity Enhancement: Granular subgroup performance analysis with intersectional assessment and targeted mitigation essential for Level 4 maturity demonstrating advanced fairness evaluation capabilities.",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: AI Fairness & Non-Discrimination Domain - Discriminatory Impact Testing and Demographic Parity Analysis. Maturity Enhancement: Systematic discriminatory impact testing with disparate impact analysis and demographic parity measurement essential for Level 3 maturity demonstrating rigorous fairness evaluation.",
    "expected_timeline": ""
  },
  {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: AI Fairness & Non-Discrimination Domain - Vulnerable Group Protection and Impact Assessment. Maturity Enhancement: Specific vulnerable group impact assessment with child safety, accessibility, and worker impact analysis essential for Level 4 maturity demonstrating comprehensive fairness protection for at-risk populations.",
    "expected_timeline": ""
  },
  {
    "control_id": "FAIR-FRIA-01",
    "control_title": "Fundamental Rights Impact Assessment",
    "category": "AI Fairness & Non-Discrimination",
    "priority": "High",
    "control_statement": "The organization SHALL conduct a fundamental rights impact assessment (FRIA) before deploying any high-risk AI system, evaluating the potential impact on the rights of affected persons, consulting relevant stakeholders, and notifying the market surveillance authority of the assessment results as required under the EU AI Act.",
    "control_objective": "Verify that the organization systematically assesses and documents the impact of high-risk AI systems on fundamental rights before deployment, ensuring affected populations are identified and appropriate mitigation measures are established.",
    "implementation": {
      "requirements": [
        "Fundamental Rights Impact Assessment Template aligned with Article 27 requirements and covering all protected rights categories",
        "Affected Population Identification Process documenting which individuals and groups may be impacted by the AI system",
        "Stakeholder Consultation Records capturing input from affected persons, civil society organizations, and equality bodies",
        "Mitigation Measures Plan specifying actions to reduce identified fundamental rights risks",
        "Market Surveillance Authority Notification documenting submission of FRIA results per Article 27(5)",
        "Implementation"
      ],
      "steps": [
        "Establish FRIA methodology aligned with EU AI Act Article 27 and relevant Union data protection legislation",
        "Identify all affected populations and assess potential impacts on fundamental rights including dignity, non-discrimination, equality, privacy, and data protection",
        "Conduct stakeholder consultations with affected persons and representative organizations",
        "Document findings with specific risk ratings per rights category and define proportionate mitigation measures",
        "Submit FRIA notification to the relevant market surveillance authority and maintain records",
        "Timeline: Completed before first deployment of each high-risk AI system; reviewed when significant changes occur or at minimum annually."
      ]
    },
    "evidence_requirements": [
      "Completed FRIA document with methodology and findings",
      "Affected population identification and analysis",
      "Stakeholder consultation records with participant details and input summary",
      "Mitigation measures plan with implementation timeline",
      "Market surveillance authority notification confirmation"
    ],
    "compliance_mapping": {
      "eu_ai_act": [
        {
          "ref": "Article 27(1)",
          "context": "Deployers of high-risk AI systems shall carry out an assessment of the impact on fundamental rights prior to putting the system into use"
        },
        {
          "ref": "Article 27(3)",
          "context": "Assessment shall include specific processes, time period, frequency, affected categories of persons"
        },
        {
          "ref": "Article 27(4)",
          "context": "If DPIA under GDPR Article 35 has been performed, the FRIA shall complement it"
        },
        {
          "ref": "Article 27(5)",
          "context": "Notify market surveillance authority of results"
        }
      ],
      "nist_ai_rmf": [
        {
          "ref": "MAP.5.1",
          "context": "Assess impacts on AI actors including affected communities"
        },
        {
          "ref": "MAP.5.2",
          "context": "Regular engagement with interested parties and affected communities"
        },
        {
          "ref": "GOVERN.5.1",
          "context": "Collect and integrate feedback from external stakeholders"
        }
      ],
      "iso_42001": [
        {
          "ref": "Clause 6.1.4",
          "context": "AI system impact assessment"
        },
        {
          "ref": "Annex A.5.2",
          "context": "AI system impact assessment process"
        },
        {
          "ref": "Annex A.5.3",
          "context": "Documentation of AI system impact assessments"
        },
        {
          "ref": "Annex A.5.4",
          "context": "Assessing impact on individuals or groups of individuals"
        },
        {
          "ref": "Annex A.5.5",
          "context": "Assessing societal impacts of AI systems"
        }
      ]
    },
    "aima_mapping": {
    ...
    "existing_certification_relevance": "None. This is an AI-specific requirement with no direct equivalent in traditional compliance frameworks such as SOC 2, ISO 27001, GDPR, ISO 9001, or others. A new process, document, or capability must be established to address this control.",
    "risk_description": "Maps to: AI Risk Management Domain — Impact Assessment. Maturity Enhancement: Establishes systematic evaluation of AI impacts on fundamental rights, moving from ad hoc awareness to structured, documented, and stakeholder-informed assessment processes.",
    "expected_timeline": ""
  }
];
...
exports.up = async function(pgm) {
  // 1. Add certification column to controls if not exists
  await pgm.db.query("ALTER TABLE crc_controls ADD COLUMN IF NOT EXISTS existing_certification_relevance TEXT");

  // 2. Clean existing tables
  await pgm.db.query("DELETE FROM crc_control_templates");
  await pgm.db.query("DELETE FROM crc_control_versions");
  await pgm.db.query("DELETE FROM crc_assessment_responses");
  await pgm.db.query("DELETE FROM crc_controls");
  ...
  var catResult = await pgm.db.query("SELECT id, name FROM crc_categories");
  var categoryMap = {};
  catResult.rows.forEach(function(row) {
    categoryMap[row.name.toLowerCase().trim()] = row.id;
  });

  // 5. Seed controls
  var BATCH_SIZE = 10;
  var insertedControls = 0;
  var COLS = 15;

  for (var i = 0; i < CONTROLS_DATA.length; i += BATCH_SIZE) {
    var batch = CONTROLS_DATA.slice(i, i + BATCH_SIZE);
    var placeholders = batch.map(function(_, rowIdx) {
      var base = rowIdx * COLS + 1;
      var tokens = [];
      for (var j = 0; j < COLS; j++) { tokens.push("\x24" + (base + j)); }
      tokens[9] += "::jsonb";
      tokens[10] += "::jsonb";
      tokens[11] += "::jsonb";
      tokens[12] += "::jsonb";
      return "(" + tokens.join(", ") + ", 3)";
    }).join(", ");
    ...
    for (var b = 0; b < batch.length; b++) {
      var ctrl = batch[b];
      var catId = categoryMap[ctrl.category.toLowerCase().trim()];
      if (!catId) {
        console.error("Category not found: " + ctrl.control_id + ": " + ctrl.category);
        skipBatch = true;
        break;
      }
      values.push(
        ...
        ctrl.control_title,
        catId,
        ctrl.expected_timeline || "",
        ctrl.priority,
        "Published",
        "{}", // applicable_to
        ctrl.control_statement,
        ctrl.control_objective,
        JSON.stringify(ctrl.implementation),
        JSON.stringify(ctrl.evidence_requirements),
        JSON.stringify(ctrl.compliance_mapping),
        JSON.stringify(ctrl.aima_mapping),
        ctrl.risk_description || "",
        ctrl.existing_certification_relevance
      );
    }
    if (skipBatch) continue;

    var query = "INSERT INTO crc_controls (control_id, control_title, category_id, expected_timeline, priority, status, applicable_to, control_statement, control_objective, implementation, evidence_requirements, compliance_mapping, aima_mapping, risk_description, existing_certification_relevance, version) VALUES " + placeholders;
    var result = await pgm.db.query(query, values);
    insertedControls += result.rowCount || 0;
  }
  console.log("Seeded " + insertedControls + " controls.");

};

exports.down = async function(pgm) {
  await pgm.db.query("ALTER TABLE crc_controls DROP COLUMN IF EXISTS existing_certification_relevance");
};
